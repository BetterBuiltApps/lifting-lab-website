      ...
      <div style={{ ...owlSiteWrap, display: 'grid', gap: 'clamp(40px,5vw,64px)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1.1fr)', gap: 'clamp(28px,4vw,60px)', alignItems: 'center' }} className="split">
          <div style={{ display: 'flex', gap: 18, justifyContent: 'center' }}>
            ...
            <Shot src="../../assets/screens/28-badges-grid-full.png" alt="Badge grid: unlocked in full color, locked desaturated" width={240} />
          </div>
          <div style={{ display: 'grid', gap: 18, justifyItems: 'center' }}>
            <Shot src="../../assets/screens/29-badge-detail-first-blood.png" alt="Badge unlocked share card" width={260} />
